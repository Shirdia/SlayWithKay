...
<div class="wrapper">
  <section class="section">
    <div class="container2">
      ...
      <?php endif ?>
      <h5><i class="fas fa-edit"></i> Edit user <span class="blue-text"><?php echo $row['user_id']; ?></span></h5>
      ...
      <form class="col s12" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" novalidate>
        ...
        <div class="row">
          <div class="input-field">
            ...
            <input type="text" id="uname" name="username" value="<?php echo $row['user_username']; ?>">
