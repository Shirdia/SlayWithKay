          ...
          <div class="card">
            <div class="row">
              <div class="col s6 m6 grey-text">
                <?php
                  $sql = "SELECT COUNT(record_sub) as sub from `record` WHERE record_sub='active' AND client_name='".$_SESSION['s_id']."'";
        ...
        <div class="col s12 m3">
          <div class="card">
            <div class="row">
              <div class="col s6 m6 grey-text">
                <?php
                  $sql = "SELECT COUNT(record_status) as status from `record` WHERE record_status='pending' AND client_name='".$_SESSION['s_id']."'";
                  $result = mysqli_query($conn, $sql);
                  $row = mysqli_fetch_array($result);
        ...
        <div class="col s12 m3">
          <div class="card">
            <div class="row">
              <div class="col s6 m6 grey-text">
                <?php
                  $sql = "SELECT COUNT(record_sub) as sub from `record` WHERE record_sub='expired' AND client_name='".$_SESSION['s_id']."'";
                  $result = mysqli_query($conn, $sql);
                  $row = mysqli_fetch_array($result);
                  echo "<h5>".$row['sub']."</h5>";
                ?>
        ...
        <div class="col s12 m3">
          <div class="card">
            <div class="row">
              <div class="col s6 m6 grey-text">
                <?php
                  $sql = "SELECT COUNT(client_name) as locker from `record` WHERE client_name='".$_SESSION['s_id']."'";
                  $result = mysqli_query($conn, $sql);
                  $row = mysqli_fetch_array($result);
          ...
          <div class="collapsible-body">
            <table class="responsive-table highlight centered">
              ...
              <tbody>
                <?php
                  $i = 1;
                  $sql = "SELECT * FROM `record` WHERE client_name='".$_SESSION['s_id']."'";
                  $result = mysqli_query($conn, $sql);
